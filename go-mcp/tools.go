...
type Args struct {
	Entity string         `json:"entity" jsonschema:"all | data | get_logo_by_name | logo"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.LogotypesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "logotypes_list",
		Description: "List records from Logotypes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "logotypes_load",
		Description: "Load a single record from Logotypes. " +
...
func runOp(client *sdk.LogotypesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.LogotypesSDK, name string) (sdk.LogotypesEntity, error) {
	switch strings.ToLower(name) {
	case "all":
		return client.All(nil), nil
	case "data":
		return client.Data(nil), nil
	case "get_logo_by_name":
		return client.GetLogoByName(nil), nil
	case "logo":
