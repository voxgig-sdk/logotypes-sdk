...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/logotypes` | `npm install @voxgig-sdk/logotypes` |
| Python | `voxgig-sdk-logotypes` | `pip install voxgig-sdk-logotypes` |
| PHP | `voxgig-sdk/logotypes` | `composer require voxgig-sdk/logotypes` |
| Golang | `github.com/voxgig-sdk/logotypes-sdk/go` | `go get github.com/voxgig-sdk/logotypes-sdk/go` |
| Ruby | `voxgig-sdk-logotypes` | `gem install voxgig-sdk-logotypes` |
| Lua | `voxgig-sdk-logotypes` | `luarocks install voxgig-sdk-logotypes` |
