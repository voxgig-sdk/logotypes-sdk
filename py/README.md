# Logotypes Python SDK



The Python SDK for the Logotypes API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/logotypes-sdk/releases)) or
...
```
py/
├── logotypes_sdk.py         -- Main SDK module
