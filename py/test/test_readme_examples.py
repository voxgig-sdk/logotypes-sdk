# Logotypes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LogotypesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LogotypesSDK(...) and LogotypesSDK.test(...) become
#      LogotypesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "logotypes_sdk"
_SDK_CLASS = "LogotypesSDK"
...
_ENTITIES = {
    "All": "all",
    "Data": "data",
    "GetLogoByName": "get_logo_by_name",
    "Logo": "logo",
}
