...
from logotypes_sdk.utility import register

# Load features
from logotypes_sdk.feature.base_feature import LogotypesBaseFeature
from logotypes_sdk.features import _has_feature, _make_feature
...
class LogotypesSDK:
    ...
    def get_utility(self):
        return LogotypesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LogotypesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetLogoByName(self, data=None) -> "GetLogoByNameEntity":
        ...
        from logotypes_sdk.entity.get_logo_by_name_entity import GetLogoByNameEntity
    ...
    def Logo(self, data=None) -> "LogoEntity":
        ...
        from logotypes_sdk.entity.logo_entity import LogoEntity
