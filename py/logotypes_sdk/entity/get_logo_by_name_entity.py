...
from logotypes_sdk.logotypes_types import (
    GetLogoByName,
...
class GetLogoByNameEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetLogoByNameEntity(self._client, opts)
    ...
    def data_get(self) -> GetLogoByName:
    ...
    def match_get(self) -> GetLogoByName:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetLogoByName:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetLogoByName().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
