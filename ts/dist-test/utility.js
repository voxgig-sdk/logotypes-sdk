...
function envOverride(m) {
    if ('TRUE' === process.env.LOGOTYPES_TEST_LIVE ||
        'TRUE' === process.env.LOGOTYPES_TEST_OVERRIDE) {
    ...
    m.LOGOTYPES_TEST_EXPLAIN = process.env.LOGOTYPES_TEST_EXPLAIN || m.LOGOTYPES_TEST_EXPLAIN;
    return m;
}
