...
(0, node_test_1.describe)('GetLogoByNameDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LogotypesSDK({
    ...
    (0, node_test_1.test)('direct-load-get_logo_by_name', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_logo_by_name', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.LOGOTYPES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LogotypesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['LOGOTYPES_TEST_GET_LOGO_BY_NAME_ENTID'];
    ...
    const client = new __1.LogotypesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetLogoByNameDirect.test.js.map