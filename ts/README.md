# Logotypes TypeScript SDK

The TypeScript SDK for the Logotypes API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `LogotypesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `LogotypesSDK.test(testopts?, sdkopts?)` | `LogotypesSDK` | Create a test-mode client. |
...
| `client` | `client(): LogotypesSDK` | Return the parent SDK client. |
...
logotypes/
├── src/
│   ├── LogotypesSDK.ts        # Main SDK class
