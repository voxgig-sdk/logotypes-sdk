...
class LogoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LOGOTYPES_TEST_LOGO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def logo_basic_setup(extra)
  ...
  entid_env_raw = ENV["LOGOTYPES_TEST_LOGO_ENTID"]
