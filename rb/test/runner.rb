...
module LogotypesTestRunner
  ...
  def self.env_override(m)
    live = getenv("LOGOTYPES_TEST_LIVE")
    override = getenv("LOGOTYPES_TEST_OVERRIDE")
    ...
    explain = getenv("LOGOTYPES_TEST_EXPLAIN")
    m["LOGOTYPES_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = LogotypesTestRunner
Helpers = LogotypesHelpers
Vs = VoxgigStruct
