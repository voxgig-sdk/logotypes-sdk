# Logotypes Ruby SDK Reference

Complete API reference for the Logotypes Ruby SDK.
...
#### `LogotypesSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Data.list(nil)
```
