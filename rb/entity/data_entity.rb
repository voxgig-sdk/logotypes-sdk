...
class DataEntity
  ...
  #
  # @param reqmatch [DataListMatch, Hash, nil] match filter (any subset of
  #   Data fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Data>, Array] the matching Data items; raises LogotypesError on failure
