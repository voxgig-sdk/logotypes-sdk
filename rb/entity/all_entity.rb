...
class AllEntity
  ...
  #
  # @param reqmatch [AllListMatch, Hash, nil] match filter (any subset of
  #   All fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<All>, Array] the matching All items; raises LogotypesError on failure
