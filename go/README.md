# Logotypes Golang SDK



The Golang SDK for the Logotypes API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/logotypes-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/logotypes-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/logotypes-sdk/go=../logotypes-sdk/go
```
...
```go
func NewLogotypesSDK(options map[string]any) *LogotypesSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *LogotypesSDK
```
...
| `All` | `(data map[string]any) LogotypesEntity` | Create an All entity instance. |
| `Data` | `(data map[string]any) LogotypesEntity` | Create a Data entity instance. |
| `GetLogoByName` | `(data map[string]any) LogotypesEntity` | Create a GetLogoByName entity instance. |
| `Logo` | `(data map[string]any) LogotypesEntity` | Create a Logo entity instance. |

### Entity interface (LogotypesEntity)

All entities implement the `LogotypesEntity` interface.
...
fmt.Println(datas) // the array of records
```
...
```
github.com/voxgig-sdk/logotypes-sdk/go/
├── logotypes.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/logotypes-sdk/go`) re-exports everything needed
