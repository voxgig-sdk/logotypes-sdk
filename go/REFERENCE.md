# Logotypes Golang SDK Reference

Complete API reference for the Logotypes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *LogotypesSDK`
