...
func (sdk *LogotypesSDK) OptionsMap() map[string]any {
...
func (sdk *LogotypesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *LogotypesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *LogotypesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LogotypesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *LogotypesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *LogotypesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("LogotypesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *LogotypesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LogotypesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("LogotypesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
