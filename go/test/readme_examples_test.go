...
const testSeed = `map[string]any{"entity": map[string]any{"all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_logo_by_name": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "logo": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
