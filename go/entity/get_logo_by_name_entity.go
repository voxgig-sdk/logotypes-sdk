...
type GetLogoByNameEntity struct {
	name    string
	client  *core.LogotypesSDK
...
func NewGetLogoByNameEntity(client *core.LogotypesSDK, entopts map[string]any) *GetLogoByNameEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetLogoByNameEntity) GetName() string { return e.name }
...
func (e *GetLogoByNameEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetLogoByNameEntity) Deleted() bool {
	return e.deleted
}


func (e *GetLogoByNameEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetLogoByNameEntity(e.client, opts)
}

func (e *GetLogoByNameEntity) Data(args ...any) any {
...
func (e *GetLogoByNameEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetLogoByName; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetLogoByNameEntity) DataTyped(data ...GetLogoByName) GetLogoByName {
	if len(data) > 0 {
		return typedFrom[GetLogoByName](e.Data(asMap(data[0])))
	}
	return typedFrom[GetLogoByName](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetLogoByName (all fields
// optional at the wire level).
func (e *GetLogoByNameEntity) MatchTyped(match ...GetLogoByName) GetLogoByName {
	if len(match) > 0 {
		return typedFrom[GetLogoByName](e.Match(asMap(match[0])))
	}
	return typedFrom[GetLogoByName](e.Match())
}
...
func (e *GetLogoByNameEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetLogoByNameEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetLogoByNameLoadMatch and returns an GetLogoByName. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetLogoByNameEntity) LoadTyped(reqmatch GetLogoByNameLoadMatch, ctrl map[string]any) (GetLogoByName, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetLogoByName{}, err
	}
	return typedFrom[GetLogoByName](res), nil
}



func (e *GetLogoByNameEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetLogoByNameEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetLogoByNameEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetLogoByNameEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetLogoByNameEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
