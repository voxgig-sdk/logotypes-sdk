...
local LogotypesSDK = {}
LogotypesSDK.__index = LogotypesSDK
...
LogotypesSDK._make_feature = _make_feature


function LogotypesSDK.new(options)
  local self = setmetatable({}, LogotypesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function LogotypesSDK:options_map()
...
function LogotypesSDK:get_utility()
  return Utility.copy(self._utility)
end


function LogotypesSDK:get_root_ctx()
  return self._rootctx
end


function LogotypesSDK:prepare(fetchargs)
...
function LogotypesSDK:direct(fetchargs)
...
-- by passing it.
function LogotypesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function LogotypesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "LogotypesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function LogotypesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = LogotypesSDK.new(sdkopts)
  sdk.mode = "test"
