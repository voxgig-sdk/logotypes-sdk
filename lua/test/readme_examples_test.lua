...
local SDK_MODULE = "logotypes_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["all"] = { ["test01"] = { id = "test01" } }, ["data"] = { ["test01"] = { id = "test01" } }, ["get_logo_by_name"] = { ["test01"] = { id = "test01" } }, ["logo"] = { ["test01"] = { id = "test01" } } } }'
