...
describe("GetLogoByNameDirect", function()
  it("should direct-load-get_logo_by_name", function()
    local setup = get_logo_by_name_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_logo_by_name", setup.live and "live" or "unit")
...
function get_logo_by_name_direct_setup(mockres)
