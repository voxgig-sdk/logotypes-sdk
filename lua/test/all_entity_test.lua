...
describe("AllEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:All(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:All(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LOGOTYPES_TEST_ALL_ENTID JSON to run live")
      return
    end
...
function all_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LOGOTYPES_TEST_ALL_ENTID")
