...
describe("DataDirect", function()
  it("should direct-list-data", function()
    local setup = data_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-data", setup.live and "live" or "unit")
