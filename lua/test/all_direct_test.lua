...
describe("AllDirect", function()
  it("should direct-list-all", function()
    local setup = all_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-all", setup.live and "live" or "unit")
