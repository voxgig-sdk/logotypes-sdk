...
local GetLogoByNameEntity = {}
GetLogoByNameEntity.__index = GetLogoByNameEntity


function GetLogoByNameEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetLogoByNameEntity)
  self._name = "get_logo_by_name"
  self._client = client
...
function GetLogoByNameEntity:get_name()
  return self._name
end


function GetLogoByNameEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetLogoByNameEntity.new(self._client, opts)
end
...
function GetLogoByNameEntity:mark_deleted()
  self._deleted = true
end


function GetLogoByNameEntity:deleted()
  return true == self._deleted
end


function GetLogoByNameEntity:data_set(args)
  if args ~= nil then
...
function GetLogoByNameEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetLogoByNameEntity:match_set(args)
  if args ~= nil then
...
function GetLogoByNameEntity:match_get()
...
function GetLogoByNameEntity:stream(action, args, callopts)
...
function GetLogoByNameEntity:_run_op(ctx, post_done)
  local utility = self._utility
