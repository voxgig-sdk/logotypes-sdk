...
from projectname_sdk.core.control import LogotypesControl
...
class LogotypesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, LogotypesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LogotypesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LogotypesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LogotypesError(code, msg, self)
