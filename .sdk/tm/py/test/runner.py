...
class LogotypesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LogotypesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LogotypesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LogotypesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
