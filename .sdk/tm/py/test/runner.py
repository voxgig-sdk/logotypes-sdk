...
class LogotypesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LogotypesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LogotypesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LogotypesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
