...
from projectname_sdk import LogotypesSDK
from projectname_sdk.core.spec import LogotypesSpec
from projectname_sdk.core.result import LogotypesResult
from projectname_sdk.core.response import LogotypesResponse
from projectname_sdk.core.operation import LogotypesOperation
from projectname_sdk.core.error import LogotypesError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import LogotypesBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LogotypesError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = LogotypesSDK.test(None, None)
        ...
        class TestInitFeature(LogotypesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LogotypesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LogotypesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LogotypesSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LogotypesSDK.test(None, setup_opts)
