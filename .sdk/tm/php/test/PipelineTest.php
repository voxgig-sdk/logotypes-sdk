...
{
    private static function utility(): LogotypesUtility
    {
        return new LogotypesUtility();
    }
    ...
    private static function ctx(array $over = []): LogotypesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LogotypesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LogotypesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LogotypesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LogotypesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LogotypesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LogotypesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LogotypesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LogotypesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LogotypesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LogotypesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LogotypesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LogotypesResponse([]),
            'result' => new LogotypesResult([]),
        ]);
        [, $err] = LogotypesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LogotypesSpec([]),
            'response' => null,
            'result' => new LogotypesResult([]),
        ]);
        [, $err] = LogotypesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LogotypesSpec(['step' => 's']),
            'response' => new LogotypesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LogotypesResult([]),
        ]);
        [, $err] = LogotypesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LogotypesSpec(['step' => 's']),
            'response' => new LogotypesResponse(self::resp(200, ['v' => 1])),
            'result' => new LogotypesResult([]),
        ]);
        [, $err] = LogotypesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LogotypesSpec(['step' => 's']),
            'response' => new LogotypesResponse(self::resp(200, ['v' => 2])),
            'result' => new LogotypesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LogotypesMakeResponse::call($ctx);
    ...
    {
        $preset = new LogotypesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LogotypesSpec([]),
            'response' => new LogotypesResponse([]),
            'result' => new LogotypesResult([]),
        ...
        [$got, $err] = LogotypesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LogotypesResult([])]);
        [, $err] = LogotypesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LogotypesSpec([]), 'result' => null]);
        [, $err] = LogotypesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LogotypesSpec(['step' => 's']),
            'result' => new LogotypesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LogotypesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LogotypesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LogotypesSpec(['step' => 's']),
            'result' => new LogotypesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LogotypesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LogotypesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LogotypesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LogotypesSpec([]),
            'result' => new LogotypesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LogotypesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LogotypesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LogotypesError('boom', 'boom');
        $utility->fetcher = function (LogotypesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LogotypesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LogotypesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LogotypesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LogotypesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LogotypesResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LogotypesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LogotypesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LogotypesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LogotypesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LogotypesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LogotypesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LogotypesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LogotypesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LogotypesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LogotypesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LogotypesResult(['ok' => false])]);
        $this->expectException(LogotypesError::class);
        LogotypesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LogotypesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LogotypesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LogotypesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LogotypesBaseFeature();
        $b = new LogotypesBaseFeature();
        LogotypesFeatureAdd::call($ctx, $a);
        LogotypesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LogotypesBaseFeature
    {
        $f = new LogotypesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LogotypesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LogotypesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LogotypesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LogotypesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LogotypesResponse(['headers' => null]),
            'result' => new LogotypesResult([]),
        ]);
        LogotypesResultHeaders::call($ctx);
