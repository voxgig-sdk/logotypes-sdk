...
// Logotypes SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LogotypesTransformResponse
{
    public static function call(LogotypesContext $ctx): mixed
    {
        ...
        $transform = LogotypesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
