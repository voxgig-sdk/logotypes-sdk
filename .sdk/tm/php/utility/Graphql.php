...
class LogotypesGraphql
{
    ...
    // equivalent.
    public static function body(LogotypesContext $ctx): mixed
    {
    ...
    public static function errors(LogotypesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
