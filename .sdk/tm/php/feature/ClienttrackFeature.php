...
// Logotypes SDK clienttrack feature
...
class LogotypesClienttrackFeature extends LogotypesBaseFeature
{
    ...
    public function PostConstruct(LogotypesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Logotypes-SDK';
