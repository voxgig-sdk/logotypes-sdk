...
// Logotypes SDK streaming feature
...
class LogotypesStreamingFeature extends LogotypesBaseFeature
{
    ...
    private function _iterate(LogotypesResult $result): \Generator
    {
    ...
    private function _streamable(LogotypesContext $ctx): bool
    {
