...
class LogotypesCacheFeature extends LogotypesBaseFeature
{
    ...
    private function _through(LogotypesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
