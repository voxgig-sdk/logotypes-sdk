...
class LogotypesRbacFeature extends LogotypesBaseFeature
{
    ...
    private function _required(LogotypesContext $ctx): ?string
    {
    ...
    private function _reject(LogotypesContext $ctx, string $required): void
    {
    ...
    private function _track(LogotypesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
