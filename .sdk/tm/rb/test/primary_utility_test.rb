...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = LogotypesOmni.make_runner(TEST_JSON_FILE, LogotypesSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : LogotypesOmni.errify(err)
    end
