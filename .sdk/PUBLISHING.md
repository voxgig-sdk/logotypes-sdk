...
|---|---|---|
| `ts/` | @voxgig-sdk/logotypes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/logotypes-sdk \
      --repository voxgig-sdk/logotypes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/logotypes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/logotypes-sdk --id=<id>` removes it.
