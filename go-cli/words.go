...
func registerSDKWords(r *eng.Registry, client *sdk.LogotypesSDK) {
...
func runOp(client *sdk.LogotypesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
