...
The PHP SDK for the Logotypes API — an entity-oriented client using PHP conventions.
...
$client = LogotypesSDK::test([
    "entity" => ["getlogobyname" => ["test01" => ["id" => "test01"]]],
]);

// Entity ops return the ENTITY (throws on error);
// call data_get() for the mock record.
$getlogobyname = $client->GetLogoByName()->load(["id" => "test01"]);
print_r($getlogobyname->data_get());
```
...
```
php/
├── logotypes_sdk.php          -- Main SDK class
...
The main class (`logotypes_sdk.php`) exports the SDK class
