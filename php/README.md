...
The PHP SDK for the Logotypes API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->All(null)->list(null, null);
...
[$result, $err] = $client->Logotypes(null)->load(
    ["id" => "test01"], null
);
