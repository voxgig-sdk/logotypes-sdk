...
class AllEntity
{
     ...
     *
     * @param AllListMatch|array|null $reqmatch Match filter (any subset
     *   of All fields) as an assoc-array; AllListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return All[]|array A list of All items as assoc-arrays at
