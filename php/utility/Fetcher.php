...
// Logotypes SDK utility: fetcher

class LogotypesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LogotypesSDK/1.0)';
    ...
    public static function call(LogotypesContext $ctx, string $fullurl, array $fetchdef): array
    {
