...
class LogoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LOGOTYPES_TEST_LOGO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function logo_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LOGOTYPES_TEST_LOGO_ENTID");
