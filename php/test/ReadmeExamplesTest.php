...
// Logotypes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LogotypesSDK::test)
...
{
    private const SDK_CLASS = 'LogotypesSDK';
    ...
    private const SDK_BASE = 'logotypes_sdk';
