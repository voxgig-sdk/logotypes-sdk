...
class LogotypesTestRunner
{
    ...
    {
        $live = self::getenv('LOGOTYPES_TEST_LIVE');
        $override = self::getenv('LOGOTYPES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('LOGOTYPES_TEST_EXPLAIN');
...
class_alias('LogotypesTestRunner', 'Runner');
class_alias('LogotypesHelpers', 'Helpers');
