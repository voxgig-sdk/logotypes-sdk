...
// Logotypes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LogotypesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LogotypesOmni::structfix($now, Struct::undef()))
                        !== json_encode(LogotypesOmni::structfix($val, Struct::undef()))) {
