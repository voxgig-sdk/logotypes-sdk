...
class LogotypesNetsimFeature extends LogotypesBaseFeature
{
    ...
    private function _simulate(LogotypesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LogotypesContext $ctx, array $applied): void
    {
        $client = $this->client;
