...
class LogotypesProxyFeature extends LogotypesBaseFeature
{
    ...
    public function init(LogotypesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LogotypesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
