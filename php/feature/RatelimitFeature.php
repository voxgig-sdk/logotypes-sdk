...
// Logotypes SDK ratelimit feature
...
class LogotypesRatelimitFeature extends LogotypesBaseFeature
{
    ...
    private function _acquire(LogotypesContext $ctx): void
    {
    ...
    private function _track(LogotypesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
