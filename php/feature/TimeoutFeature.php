...
class LogotypesTimeoutFeature extends LogotypesBaseFeature
{
    ...
    private function _with_timeout(LogotypesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LogotypesContext $_ctx, float $ms): void
    {
        $client = $this->client;
