...
// Logotypes SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LogotypesTestFeature extends LogotypesBaseFeature
{
    ...
    public function init(LogotypesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LogotypesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = LogotypesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LogotypesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LogotypesContext $ctx, $op, $args): array
    {
