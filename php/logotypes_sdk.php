...
class LogotypesSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = LogotypesHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = LogotypesHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!LogotypesFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, LogotypesFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return LogotypesUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = LogotypesHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = LogotypesHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = LogotypesHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new LogotypesError($op . "_allow",
                "LogotypesSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = LogotypesHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new LogotypesError("graphql_error",
                "LogotypesSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetLogoByName($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_logo_by_name === null) {
                $this->_get_logo_by_name = new GetLogoByNameEntity($this, null);
            }
            return $this->_get_logo_by_name;
        }
        return new GetLogoByNameEntity($this, $data);
    }
